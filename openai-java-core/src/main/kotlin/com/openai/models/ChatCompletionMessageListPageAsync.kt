...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ChatCompletionMessageListPageAsync && messagesService == other.messagesService && params == other.params && response == other.response /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(messagesService, params, response) /* spotless:on */

    override fun toString() =
        "ChatCompletionMessageListPageAsync{messagesService=$messagesService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<ChatCompletionMessageListPageAsync>> {
    ...
    class AutoPager(private val firstPage: ChatCompletionMessageListPageAsync) {
        ...
        fun toList(executor: Executor): CompletableFuture<List<ChatCompletionStoreMessage>> {
            val values = mutableListOf<ChatCompletionStoreMessage>()
