 ...
 */
class ChatCompletionMessageListParams
private constructor(
    ...
    /** A builder for [ChatCompletionMessageListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(chatCompletionMessageListParams: ChatCompletionMessageListParams) =
            apply {
                completionId = chatCompletionMessageListParams.completionId
                after = chatCompletionMessageListParams.after
                limit = chatCompletionMessageListParams.limit
                order = chatCompletionMessageListParams.order
                additionalHeaders = chatCompletionMessageListParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    chatCompletionMessageListParams.additionalQueryParams.toBuilder()
            }
        ...
        fun build(): ChatCompletionMessageListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ChatCompletionMessageListParams && completionId == other.completionId && after == other.after && limit == other.limit && order == other.order && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "ChatCompletionMessageListParams{completionId=$completionId, after=$after, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
