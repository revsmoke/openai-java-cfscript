...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FineTuningJobRetrieveParams && this.fineTuningJobId == other.fineTuningJobId && this.additionalQueryParams == other.additionalQueryParams && this.additionalHeaders == other.additionalHeaders /* spotless:on */
    }

    override fun hashCode(): Int {
        return /* spotless:off */ Objects.hash(fineTuningJobId, additionalQueryParams, additionalHeaders) /* spotless:on */
    }
