...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<FileObject>> = JsonMissing.of(),
     ...
     */
    fun data(): List<FileObject> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<FileObject>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<FileObject>>? = null
        ...
        internal fun from(fileListPageResponse: FileListPageResponse) = apply {
            ...
            object_ = fileListPageResponse.object_
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<FileObject>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<FileObject>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [FileObject] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: FileObject) = apply {
            this.data =
    ...
    override fun toString() =
        "FileListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
