...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaVectorStoreListParams: BetaVectorStoreListParams) = apply {
            after = betaVectorStoreListParams.after
            before = betaVectorStoreListParams.before
            limit = betaVectorStoreListParams.limit
            order = betaVectorStoreListParams.order
            additionalHeaders = betaVectorStoreListParams.additionalHeaders.toBuilder()
            additionalQueryParams = betaVectorStoreListParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): BetaVectorStoreListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BetaVectorStoreListParams && after == other.after && before == other.before && limit == other.limit && order == other.order && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "BetaVectorStoreListParams{after=$after, before=$before, limit=$limit, order=$order, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
