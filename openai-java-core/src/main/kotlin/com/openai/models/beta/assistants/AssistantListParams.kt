...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AssistantListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(assistantListParams: AssistantListParams) = apply {
            after = assistantListParams.after
            before = assistantListParams.before
            limit = assistantListParams.limit
            order = assistantListParams.order
