...
private constructor(
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Assistant>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Assistant> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Assistant>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Assistant>>? = null
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Assistant>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Assistant>>) = apply {
