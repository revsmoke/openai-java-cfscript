...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messageUpdateParams: MessageUpdateParams) = apply {
            threadId = messageUpdateParams.threadId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MessageUpdateParams && threadId == other.threadId && messageId == other.messageId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "MessageUpdateParams{threadId=$threadId, messageId=$messageId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
