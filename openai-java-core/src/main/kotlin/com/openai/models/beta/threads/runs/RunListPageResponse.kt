...
private constructor(
    private val data: JsonField<List<Run>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Run>> = JsonMissing.of(),
     ...
     */
    fun data(): List<Run> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Run>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RunListPageResponse].
         *
    ...
    /** A builder for [RunListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<Run>>? = null
        ...
        @JvmSynthetic
        internal fun from(runListPageResponse: RunListPageResponse) = apply {
            data = runListPageResponse.data.map { it.toMutableList() }
            firstId = runListPageResponse.firstId
            hasMore = runListPageResponse.hasMore
            lastId = runListPageResponse.lastId
            object_ = runListPageResponse.object_
            additionalProperties = runListPageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Run>` value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<Run>>) = apply { this.data = data.map { it.toMutableList() } }

        /**
         * Adds a single [Run] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Run) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [RunListPageResponse].
         *
    ...
    fun validate(): RunListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is RunListPageResponse && data == other.data && firstId == other.firstId && hasMore == other.hasMore && lastId == other.lastId && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "RunListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
