...
private constructor(
    ...
    fun getNextPageParams(): Optional<StepListParams> {
        ...
        return Optional.of(StepListParams.builder().from(params).after(data().last().id()).build())
    }
    ...
    companion object {
        ...
        @JvmStatic
        fun of(stepsService: StepServiceAsync, params: StepListParams, response: Response) =
