...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        private var object_: JsonValue = JsonValue.from("thread.deleted")
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(threadDeleted: ThreadDeleted) = apply {
            id = threadDeleted.id
            deleted = threadDeleted.deleted
            object_ = threadDeleted.object_
            additionalProperties = threadDeleted.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): ThreadDeleted = apply {
        if (validated) {
            return@apply
        }
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("thread.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("thread.deleted")) 1 else 0 }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ThreadDeleted && id == other.id && deleted == other.deleted && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ThreadDeleted{id=$id, deleted=$deleted, object_=$object_, additionalProperties=$additionalProperties}"
}
