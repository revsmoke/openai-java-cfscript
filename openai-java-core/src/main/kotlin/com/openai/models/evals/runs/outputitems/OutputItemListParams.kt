...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OutputItemListParams].
         *
    ...
    /** A builder for [OutputItemListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(outputItemListParams: OutputItemListParams) = apply {
            evalId = outputItemListParams.evalId
            runId = outputItemListParams.runId
            after = outputItemListParams.after
            limit = outputItemListParams.limit
            order = outputItemListParams.order
            status = outputItemListParams.status
            additionalHeaders = outputItemListParams.additionalHeaders.toBuilder()
            additionalQueryParams = outputItemListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [OutputItemListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is OutputItemListParams && evalId == other.evalId && runId == other.runId && after == other.after && limit == other.limit && order == other.order && status == other.status && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(evalId, runId, after, limit, order, status, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "OutputItemListParams{evalId=$evalId, runId=$runId, after=$after, limit=$limit, order=$order, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
