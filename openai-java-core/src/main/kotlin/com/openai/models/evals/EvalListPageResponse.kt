...
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EvalListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<EvalListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<EvalListResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EvalListPageResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<EvalListResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(evalListPageResponse: EvalListPageResponse) = apply {
            data = evalListPageResponse.data.map { it.toMutableList() }
            firstId = evalListPageResponse.firstId
            hasMore = evalListPageResponse.hasMore
            lastId = evalListPageResponse.lastId
            object_ = evalListPageResponse.object_
            additionalProperties = evalListPageResponse.additionalProperties.toMutableMap()
        }

        /** An array of eval objects. */
        fun data(data: List<EvalListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<EvalListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<EvalListResponse>>) = apply {
         ...
         */
        fun addData(data: EvalListResponse) = apply {
            this.data =
         ...
         */
        fun build(): EvalListPageResponse =
            EvalListPageResponse(
    ...
    fun validate(): EvalListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EvalListPageResponse && data == other.data && firstId == other.firstId && hasMore == other.hasMore && lastId == other.lastId && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "EvalListPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
