...
private constructor(
    ...
    /** A builder for [OutputItemRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(outputItemRetrieveResponse: OutputItemRetrieveResponse) = apply {
            id = outputItemRetrieveResponse.id
            createdAt = outputItemRetrieveResponse.createdAt
            datasourceItem = outputItemRetrieveResponse.datasourceItem
            datasourceItemId = outputItemRetrieveResponse.datasourceItemId
            evalId = outputItemRetrieveResponse.evalId
            object_ = outputItemRetrieveResponse.object_
            results = outputItemRetrieveResponse.results.map { it.toMutableList() }
            runId = outputItemRetrieveResponse.runId
            sample = outputItemRetrieveResponse.sample
            status = outputItemRetrieveResponse.status
            additionalProperties = outputItemRetrieveResponse.additionalProperties.toMutableMap()
        }
         ...
         */
        fun build(): OutputItemRetrieveResponse =
    ...
    fun validate(): OutputItemRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun toString() =
        "OutputItemRetrieveResponse{id=$id, createdAt=$createdAt, datasourceItem=$datasourceItem, datasourceItemId=$datasourceItemId, evalId=$evalId, object_=$object_, results=$results, runId=$runId, sample=$sample, status=$status, additionalProperties=$additionalProperties}"
}
