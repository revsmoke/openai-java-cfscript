...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(evalUpdateResponse: EvalUpdateResponse) = apply {
            id = evalUpdateResponse.id
            createdAt = evalUpdateResponse.createdAt
            dataSourceConfig = evalUpdateResponse.dataSourceConfig
            metadata = evalUpdateResponse.metadata
            name = evalUpdateResponse.name
            object_ = evalUpdateResponse.object_
            testingCriteria = evalUpdateResponse.testingCriteria.map { it.toMutableList() }
            additionalProperties = evalUpdateResponse.additionalProperties.toMutableMap()
        }
    ...
    fun validate(): EvalUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EvalUpdateResponse && id == other.id && createdAt == other.createdAt && dataSourceConfig == other.dataSourceConfig && metadata == other.metadata && name == other.name && object_ == other.object_ && testingCriteria == other.testingCriteria && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "EvalUpdateResponse{id=$id, createdAt=$createdAt, dataSourceConfig=$dataSourceConfig, metadata=$metadata, name=$name, object_=$object_, testingCriteria=$testingCriteria, additionalProperties=$additionalProperties}"
}
