...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(runListResponse: RunListResponse) = apply {
            ...
            createdAt = runListResponse.createdAt
            dataSource = runListResponse.dataSource
            error = runListResponse.error
            evalId = runListResponse.evalId
            metadata = runListResponse.metadata
            model = runListResponse.model
            name = runListResponse.name
            object_ = runListResponse.object_
            perModelUsage = runListResponse.perModelUsage.map { it.toMutableList() }
            perTestingCriteriaResults =
                runListResponse.perTestingCriteriaResults.map { it.toMutableList() }
            reportUrl = runListResponse.reportUrl
            resultCounts = runListResponse.resultCounts
            status = runListResponse.status
