...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(evalCreateResponse: EvalCreateResponse) = apply {
            ...
            shareWithOpenAI = evalCreateResponse.shareWithOpenAI
    ...
    override fun toString() =
        "EvalCreateResponse{id=$id, createdAt=$createdAt, dataSourceConfig=$dataSourceConfig, metadata=$metadata, name=$name, object_=$object_, shareWithOpenAI=$shareWithOpenAI, testingCriteria=$testingCriteria, additionalProperties=$additionalProperties}"
}
