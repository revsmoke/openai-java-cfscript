...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(responseInputMessageItem: ResponseInputMessageItem) = apply {
         ...
         *
         * You should usually call [Builder.content] with a well-typed `List<ResponseInputContent>`
         ...
         */
        fun build(): ResponseInputMessageItem =
    ...
    fun validate(): ResponseInputMessageItem = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ResponseInputMessageItem && id == other.id && content == other.content && role == other.role && status == other.status && type == other.type && additionalProperties == other.additionalProperties /* spotless:on */
    }
