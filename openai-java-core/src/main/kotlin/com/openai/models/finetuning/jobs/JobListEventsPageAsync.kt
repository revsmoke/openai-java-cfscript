...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic
        fun of(jobsService: JobServiceAsync, params: JobListEventsParams, response: Response) =
    ...
    class Response(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("data") data: JsonField<List<FineTuningJobEvent>> = JsonMissing.of(),
            @JsonProperty("has_more") hasMore: JsonField<Boolean> = JsonMissing.of(),
        ) : this(data, hasMore, mutableMapOf())

        fun data(): List<FineTuningJobEvent> = data.getOptional("data").getOrNull() ?: listOf()
