...
class PermissionCreatePageResponse
private constructor(
     ...
     */
    fun data(): List<PermissionCreateResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<PermissionCreateResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PermissionCreatePageResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<PermissionCreateResponse>>? = null
        ...
        @JvmSynthetic
        internal fun from(permissionCreatePageResponse: PermissionCreatePageResponse) = apply {
            data = permissionCreatePageResponse.data.map { it.toMutableList() }
            hasMore = permissionCreatePageResponse.hasMore
            object_ = permissionCreatePageResponse.object_
            firstId = permissionCreatePageResponse.firstId
            lastId = permissionCreatePageResponse.lastId
            additionalProperties = permissionCreatePageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<PermissionCreateResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<PermissionCreateResponse>>) = apply {
         ...
         */
        fun addData(data: PermissionCreateResponse) = apply {
            this.data =
         ...
         */
        fun build(): PermissionCreatePageResponse =
    ...
    fun validate(): PermissionCreatePageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PermissionCreatePageResponse && data == other.data && hasMore == other.hasMore && object_ == other.object_ && firstId == other.firstId && lastId == other.lastId && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "PermissionCreatePageResponse{data=$data, hasMore=$hasMore, object_=$object_, firstId=$firstId, lastId=$lastId, additionalProperties=$additionalProperties}"
}
