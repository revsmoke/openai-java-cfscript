...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(uploadPartCreateParams: UploadPartCreateParams) = apply {
            uploadId = uploadPartCreateParams.uploadId
            body = uploadPartCreateParams.body.toBuilder()
            additionalHeaders = uploadPartCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = uploadPartCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        fun build(): UploadPartCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is UploadPartCreateParams && uploadId == other.uploadId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "UploadPartCreateParams{uploadId=$uploadId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
