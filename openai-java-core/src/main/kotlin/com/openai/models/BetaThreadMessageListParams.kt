...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(betaThreadMessageListParams: BetaThreadMessageListParams) = apply {
            threadId = betaThreadMessageListParams.threadId
            after = betaThreadMessageListParams.after
            before = betaThreadMessageListParams.before
            limit = betaThreadMessageListParams.limit
            order = betaThreadMessageListParams.order
            runId = betaThreadMessageListParams.runId
            additionalHeaders = betaThreadMessageListParams.additionalHeaders.toBuilder()
            additionalQueryParams = betaThreadMessageListParams.additionalQueryParams.toBuilder()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BetaThreadMessageListParams && threadId == other.threadId && after == other.after && before == other.before && limit == other.limit && order == other.order && runId == other.runId && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(threadId, after, before, limit, order, runId, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "BetaThreadMessageListParams{threadId=$threadId, after=$after, before=$before, limit=$limit, order=$order, runId=$runId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
