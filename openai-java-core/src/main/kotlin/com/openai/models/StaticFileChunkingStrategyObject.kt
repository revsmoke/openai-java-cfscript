...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is StaticFileChunkingStrategyObject && type == other.type && static_ == other.static_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "StaticFileChunkingStrategyObject{type=$type, static_=$static_, additionalProperties=$additionalProperties}"
}
