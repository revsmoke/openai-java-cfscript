...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FineTuningJobListEventsPageAsync && jobsService == other.jobsService && params == other.params && response == other.response /* spotless:on */
    }
    ...
    companion object {
        ...
        fun of(
            ...
            response: Response,
        ) = FineTuningJobListEventsPageAsync(jobsService, params, response)
    }
    ...
    class AutoPager(private val firstPage: FineTuningJobListEventsPageAsync) {
