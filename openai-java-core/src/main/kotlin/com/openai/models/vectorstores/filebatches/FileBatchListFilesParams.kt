...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileBatchListFilesParams: FileBatchListFilesParams) = apply {
            vectorStoreId = fileBatchListFilesParams.vectorStoreId
            batchId = fileBatchListFilesParams.batchId
            after = fileBatchListFilesParams.after
            before = fileBatchListFilesParams.before
            filter = fileBatchListFilesParams.filter
            limit = fileBatchListFilesParams.limit
            order = fileBatchListFilesParams.order
            additionalHeaders = fileBatchListFilesParams.additionalHeaders.toBuilder()
            additionalQueryParams = fileBatchListFilesParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FileBatchListFilesParams].
         *
