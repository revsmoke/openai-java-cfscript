...
class FileBatchListFilesPageResponse
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<VectorStoreFile>> = JsonMissing.of(),
     ...
     */
    fun data(): List<VectorStoreFile> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<VectorStoreFile>> = data
    ...
    companion object {
         ...
         * [FileBatchListFilesPageResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<VectorStoreFile>>? = null
        ...
        @JvmSynthetic
        internal fun from(fileBatchListFilesPageResponse: FileBatchListFilesPageResponse) = apply {
            data = fileBatchListFilesPageResponse.data.map { it.toMutableList() }
            firstId = fileBatchListFilesPageResponse.firstId
            hasMore = fileBatchListFilesPageResponse.hasMore
            lastId = fileBatchListFilesPageResponse.lastId
            object_ = fileBatchListFilesPageResponse.object_
            additionalProperties =
                fileBatchListFilesPageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<VectorStoreFile>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<VectorStoreFile>>) = apply {
         ...
         */
        fun addData(data: VectorStoreFile) = apply {
            this.data =
         ...
         */
        fun build(): FileBatchListFilesPageResponse =
            FileBatchListFilesPageResponse(
    ...
    fun validate(): FileBatchListFilesPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is FileBatchListFilesPageResponse && data == other.data && firstId == other.firstId && hasMore == other.hasMore && lastId == other.lastId && object_ == other.object_ && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "FileBatchListFilesPageResponse{data=$data, firstId=$firstId, hasMore=$hasMore, lastId=$lastId, object_=$object_, additionalProperties=$additionalProperties}"
}
