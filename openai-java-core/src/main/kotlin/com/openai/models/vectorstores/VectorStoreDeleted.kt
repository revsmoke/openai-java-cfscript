...
private constructor(
     ...
     * ```java
     * JsonValue.from("vector_store.deleted")
     * ```
     *
    ...
    /** A builder for [VectorStoreDeleted]. */
    class Builder internal constructor() {

        private var id: JsonField<String>? = null
        private var deleted: JsonField<Boolean>? = null
        private var object_: JsonValue = JsonValue.from("vector_store.deleted")
        ...
        /**
         * Returns an immutable instance of [VectorStoreDeleted].
         *
    ...
    fun validate(): VectorStoreDeleted = apply {
        ...
        deleted()
        _object_().let {
            if (it != JsonValue.from("vector_store.deleted")) {
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            object_.let { if (it == JsonValue.from("vector_store.deleted")) 1 else 0 }
