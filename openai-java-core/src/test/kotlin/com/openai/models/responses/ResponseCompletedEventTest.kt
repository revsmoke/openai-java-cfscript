    ...
    fun roundtrip() {
        ...
        val roundtrippedResponseCompletedEvent =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(responseCompletedEvent),
                jacksonTypeRef<ResponseCompletedEvent>(),
            )

        assertThat(roundtrippedResponseCompletedEvent).isEqualTo(responseCompletedEvent)
    }
}
