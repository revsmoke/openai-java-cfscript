package com.openai.api.core

import com.fasterxml.jackson.databind.json.JsonMapper
import com.google.common.collect.ArrayListMultimap
import com.google.common.collect.ListMultimap
import com.openai.api.core.http.HttpClient
import com.openai.api.core.http.RetryingHttpClient
...
private constructor(
    ...
    class Builder {
        ...
        fun fromEnv() = apply { System.getenv("OPENAI_API_KEY")?.let { apiKey(it) } }
