...
constructor(
     ...
     */
    override fun create(params: FineTuneCreateParams, requestOptions: RequestOptions): FineTune {
        val request =
            HttpRequest.builder()
    ...
    override fun cancel(params: FineTuneCancelParams, requestOptions: RequestOptions): FineTune {
        val request =
            HttpRequest.builder()
                .method(HttpMethod.POST)
