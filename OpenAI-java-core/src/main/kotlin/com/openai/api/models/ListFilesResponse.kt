...
private constructor(
    ...
    override fun toString() =
        "ListFilesResponse{object_=$object_, data=$data, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        internal fun from(listFilesResponse: ListFilesResponse) = apply {
            this.object_ = listFilesResponse.object_
            this.data = listFilesResponse.data
            additionalProperties(listFilesResponse.additionalProperties)
        }
