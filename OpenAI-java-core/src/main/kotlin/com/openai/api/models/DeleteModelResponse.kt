...
private constructor(
    ...
    fun validate(): DeleteModelResponse = apply {
        if (!validated) {
            id()
            object_()
            deleted()
    ...
    override fun toString() =
        "DeleteModelResponse{id=$id, object_=$object_, deleted=$deleted, additionalProperties=$additionalProperties}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(deleteModelResponse: DeleteModelResponse) = apply {
            this.id = deleteModelResponse.id
            this.object_ = deleteModelResponse.object_
            this.deleted = deleteModelResponse.deleted
            additionalProperties(deleteModelResponse.additionalProperties)
        }
